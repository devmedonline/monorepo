...
type FormDataSerializable = FormDataBasicValue | FormDataBasicValue[] | { [key: string]: FormDataSerializable };

type URLSearchParamsBasicValue = string | number | boolean | null | undefined | Date;
type URLSearchParamsSerializable = { [key: string]: URLSearchParamsBasicValue | URLSearchParamsBasicValue[] };

type HTTPMethod = "GET" | "POST" | "PUT" | "PATCH" | "DELETE" | "HEAD" | "OPTIONS" | "TRACE" | "CONNECT";
type Guard<T extends SuccessResponseData> = (data: SuccessResponseData) => data is T;

type HttpClientRequestInit = Omit<RequestInit, "body" | "method" | "searchParams"> & {
  method: HTTPMethod;
...
type SpecificRequestOptions<T extends SuccessResponseData> = Omit<RequestOptions<T>, "init"> & {
...
export class HttpClient {
  ...
  private readonly logger?: (request: RequestOptions<any>, response: ApiResponse<any>) => void;
   ...
   */
  public async createRequest<T extends SuccessResponseData>(options: RequestOptions<T>): Promise<SuccessResponse<T>> {
    ...
    if (init && init.searchParams) {
      if (init.searchParams instanceof URLSearchParams) {
        ...
        serializedSearchParams = serializeURLSearchParams(init.searchParams).toString();
      }
    }
    ...
    if (!response.ok || isErrorResponse(parsedResponse)) {
      const errorResponse = isErrorResponse(parsedResponse) ? parsedResponse : undefined;
      ...
      const code = errorResponse ? errorResponse.code : "HTTP_" + response.status;
  ...
  public async request<T extends SuccessResponseData>(options: RequestOptions<T>): Promise<SuccessResponse<T>> {
    try {
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public get<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "GET" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public post<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "POST" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public put<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "PUT" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public patch<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "PATCH" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public delete<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "DELETE" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public head<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "HEAD" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public options<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "OPTIONS" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public trace<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "TRACE" } });
  }
   ...
   * @returns Uma Promise com o resultado da requisição HTTP
   */
  public connect<T extends SuccessResponseData>(options: SpecificRequestOptions<T>): Promise<SuccessResponse<T>> {
    return this.request({ ...options, init: { ...options.init, method: "CONNECT" } });
  }
}
...
export function serializeURLSearchParams(searchParams: URLSearchParamsSerializable): URLSearchParams {
