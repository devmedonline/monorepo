...
import { useUpdateSimulationForm } from "../hooks/use-update-simulation-form";
...
export function UpdateSimulationForm({
  ...
  const { form, onSubmit } = useUpdateSimulationForm({
    onSuccess,
    defaultValues,
  });
...
type UpdateSimulationDialogTriggerProps = {
  children: React.ReactNode;
  defaultValues: Simulation;
};
export function UpdateSimulationDialogTrigger({
  children,
  defaultValues,
}: UpdateSimulationDialogTriggerProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Atualizar {defaultValues.title}</DialogTitle>
        </DialogHeader>
